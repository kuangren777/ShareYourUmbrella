# Generated by Django 4.1.7 on 2023-11-16 15:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "alarm_type_id",
                    models.CharField(max_length=20, unique=True, verbose_name="警报类型ID"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "repair_type_id",
                    models.CharField(max_length=20, unique=True, verbose_name="维护类型ID"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "site_id",
                    models.CharField(max_length=20, unique=True, verbose_name="站点ID"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("umbrella_id", models.CharField(max_length=20, verbose_name="伞ID")),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "umbrella_id",
                    models.CharField(max_length=20, unique=True, verbose_name="伞ID"),
                ),
                (
                ...
                (
                    "umbrella_type_id",
                    models.CharField(max_length=20, verbose_name="伞类型ID"),
                ),
                ...
                (
                    ...
                    models.DateTimeField(verbose_name="上次使用日期"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "umbrella_type_id",
                    models.CharField(max_length=20, unique=True, verbose_name="伞类型ID"),
                ),
                ("umbrella_type", models.CharField(max_length=50, verbose_name="伞类型")),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_id",
                    models.CharField(max_length=20, unique=True, verbose_name="用户ID"),
                ),
                (
                    "user_name",
                ...
                (
                    "user_umbrella_id",
                    models.CharField(max_length=50, verbose_name="用户目前使用的伞号"),
                ),
                (
                    "user_photo",
                    models.ImageField(
                ...
                (
                    "user_password",
                    models.CharField(max_length=50, verbose_name="用户登录密码"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "repair_id",
                    models.CharField(max_length=20, unique=True, verbose_name="维护ID"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "recharge_id",
                    models.CharField(max_length=20, unique=True, verbose_name="充值记录ID"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "diary_id",
                    models.CharField(max_length=20, unique=True, verbose_name="日志ID"),
                ),
                (
                    "lending_site_id",
                    models.CharField(max_length=20, verbose_name="借出站点ID"),
                ),
                (
                    "lending_lay_id",
                ...
                (
                    "return_site_id",
                    models.CharField(max_length=20, verbose_name="归还站点ID"),
                ),
                (
                    "return_lay_id",
                    models.CharField(max_length=50, verbose_name="归还详细序号"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "coupon_id",
                    models.CharField(max_length=20, unique=True, verbose_name="优惠券ID"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "alarm_id",
                    models.CharField(max_length=20, unique=True, verbose_name="警报ID"),
                ),
